...
const handleHealth = (req, res) => {
  res.json({ status: 'ok', environment: process.env.VERCEL ? 'vercel' : 'local', time: new Date().toISOString() });
};
app.get('/api/health', handleHealth);
app.get('/health', handleHealth);

// Video info & transcript handler (supports both /api/video-info and /video-info)
const handleVideoInfo = async (req, res) => {
...
app.get('/api/video-info', handleVideoInfo);
app.get('/video-info', handleVideoInfo);
